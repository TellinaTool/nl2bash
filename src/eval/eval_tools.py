...
from src.eval import token_based
from src.eval import tree_dist
from src.nlp_tools import canonicalize_text, constants
...
def get_automatic_evaluation_metrics(grouped_dataset, prediction_list, vocabs, flags, top_k,
    ...
    rev_nl_vocab = vocabs.rev_nl_vocab if vocabs is not None else None
