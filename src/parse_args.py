...
def define_input_flags():
    ...
    tf.compat.v1.flags.DEFINE_integer('max_nl_seq_len', 100, 'Maximum source sequence length.')
    tf.compat.v1.flags.DEFINE_integer('max_cm_seq_len', 100, 'Maximum target sequence length.')
    tf.compat.v1.flags.DEFINE_integer('nl_vocab_size', 1000, 'Source vocabulary size.')
    tf.compat.v1.flags.DEFINE_integer('cm_vocab_size', 1000, 'Target vocabulary size.')
    tf.compat.v1.flags.DEFINE_integer('max_nl_token_size', 100, 'Maximum source token size.')
    tf.compat.v1.flags.DEFINE_integer('max_cm_token_size', 100, 'Maximum target token size.')
    ...
    tf.compat.v1.flags.DEFINE_boolean('cm_token_use_attention', False, 'If set, use attention for token decoder.')
    tf.compat.v1.flags.DEFINE_boolean('tg_char_use_attention', False, 'If set, use attention for char decoder.')
    tf.compat.v1.flags.DEFINE_string('cm_token_attn_fun', 'inner_product',
    ...
    tf.compat.v1.flags.DEFINE_boolean('nl_token', True,
                                'Set to True to turn on the token channel in the encoder. On by default.')
    tf.compat.v1.flags.DEFINE_integer('nl_token_embedding_size', 1000, 'source word embedding size.')
    tf.compat.v1.flags.DEFINE_integer('nl_token_dim', 300, 'Basic token embedding dimensions.')
    ...
    tf.compat.v1.flags.DEFINE_boolean('cm_token', True,
                                'Set to True to turn on the token channel in the decoder. On by default.')
    tf.compat.v1.flags.DEFINE_integer('cm_token_embedding_size', 1000, 'target word embedding size.')
