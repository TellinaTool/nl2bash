...
2. If you run your own manual evaluation, please release [the examples you annotated with their annotations](https://github.com/TellinaTool/nl2bash/tree/master/data/bash/manual_judgements). This helps the community to replicate the results and future work could reuse these annotations.
