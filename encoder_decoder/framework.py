...
class EncoderDecoderModel(graph_utils.NNModel):
    ...
    def get_batch(self, data, bucket_id):
        ...
        for _ in xrange(self.batch_size):
            ...
            print("target_ids: {}".format(random_example[3]))
            decoder_full_inputs.append(random_example[5])
            print("target_full_ids: {}".format(random_example[5]))
            if self.use_copy and self.copy_fun == 'supervised':
    ...
    def feed_input(self, E):
        ...
        for l in xrange(decoder_size):
            ...
            input_feed[self.decoder_full_inputs[l].name] = E.decoder_full_inputs[l]
